...
#library(devtools)
#install_github("alemermartinez/rplam",force=TRUE)
#library(rplam)
...
#source("simu_splines_robusto_new.R")
source("simu_splines_robusto_new-newm3.R")
...
try( simulacion(ejemplo, NITER,anterior,tipo.cont,n,desvio.epsilon,epsilon,degree.spline,typePhi) )
