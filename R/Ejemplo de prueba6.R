...
# Selected covariates as in Hardle et al. (2004)
x1 <- datos$V1
x2 <- datos$V3
x3 <- datos$V5
x4 <- datos$V6
...
Z <- cbind(datos$V7, log(datos$V8), log(datos$V9), datos$V10,
           datos$V11, datos$V12, log(datos$V13), datos$V1,
           datos$V2, datos$V3, datos$V4)
X <- cbind(datos$V6, datos$V5)
