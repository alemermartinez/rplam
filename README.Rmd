...
ggplot(DF3,aes(x=Temp,y=re.1,color=Fit)) +
  ...
  geom_point(data=DF3point,aes(x=x1,y=re1),col='#FF33E3',size=2)+
  theme(
    axis.title.y=element_blank()
  )
...
ggplot(DF3,aes(x=Wind,y=re.2,color=Fit)) +
  ...
  scale_color_manual(values = c("#0052bb"))+
  geom_point(data=DF3point,aes(x=x2,y=re2),col='#FF33E3',size=2)+
  theme(
    axis.title.y=element_blank()
  )
...
ggplot(DF3,aes(x=Solar.R,y=re.3,color=Fit)) +
  ...
  scale_color_manual(values = c("#0052bb"))+
  geom_point(data=DF3point,aes(x=x3,y=re3),col='#FF33E3',size=2)+
  theme(
    axis.title.y=element_blank()
  )
...
dim(DF4)
names(DF4) <- c("Temp","Wind","Solar.R","re.1", "re.2", "re.3", "g1","g2","g3","Fit")
str(DF4)

ggplot(DF4,aes(x=Temp,y=re.1,color=Fit)) +
  geom_point(alpha=0.5)+
  geom_line(aes(x=Temp,y=g1),size=1.3,alpha=1,linetype=c(rep(2,107),rep(1,111)))+
  scale_color_manual(values = c("#bb0c00","#0052bb"))+
  geom_point(data=DF3point,aes(x=x1,y=re1),col='#FF33E3',size=2)+
  theme(
    axis.title.y=element_blank()
...
ggplot(DF4,aes(x=Wind,y=re.2,color=Fit)) +
  geom_point(alpha=0.5)+
  geom_line(aes(x=Wind,y=g2),size=1.3,alpha=1,linetype=c(rep(2,107),rep(1,111)))+
  scale_color_manual(values = c("#bb0c00","#0052bb"))+
  geom_point(data=DF3point,aes(x=x2,y=re2),col='#FF33E3',size=2)+
  theme(
    axis.title.y=element_blank()
...
ggplot(DF4,aes(x=Solar.R,y=re.3,color=Fit)) +
  geom_point(alpha=0.5)+
  geom_line(aes(x=Solar.R,y=g3),size=1.3,alpha=1,linetype=c(rep(2,107),rep(1,111)))+
  scale_color_manual(values = c("#bb0c00","#0052bb"))+
  geom_point(data=DF3point,aes(x=x3,y=re3),col='#FF33E3',size=2)+
  theme(
    axis.title.y=element_blank()
