...
outliers
```
Highlighting the partial residuals of these four observations (in pink) we obtain the following plots:
...
```
```{r tabla final, echo=FALSE}
tabla2 <- rbind(tabla.b1.aux[2,], c(desvio.cl.full.A,   desvio.rob.BD, desvio.cl.clean.A))
tabla.paper.beta <- round(tabla2, 4)
