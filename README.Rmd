...
col2 <- round(c(fit.full.cl$coeff.const,fit.full.cl$coeff.lin),4)
col3 <- round(c(fit.rob$coeff.const,fit.rob$coeff.lin),4)
...
DF2 <- as.data.frame(list(
  rbind(X,X),
  c(rep(NA,n),fit.rob$y  - fit.rob$Z%*%fit.rob$coeff.lin - fit.rob$coeff.const - rowSums(fit.rob$g.matrix[,-1])),
  c(rep(NA,n),fit.rob$y  - fit.rob$Z%*%fit.rob$coeff.lin - fit.rob$coeff.const - rowSums(fit.rob$g.matrix[,-2])),
  c(rep(NA,n),fit.rob$y  - fit.rob$Z%*%fit.rob$coeff.lin - fit.rob$coeff.const - rowSums(fit.rob$g.matrix[,-3])),
...
```{r echo=FALSE, results='asis'}
col4 <- round(c(fit.del.cl$coeff.const,fit.del.cl$coeff.lin),4)
...
DF3point <- as.data.frame(list(
  X[outliers,],
  (fit.rob$y  - fit.rob$Z%*%fit.rob$coeff.lin - fit.rob$coeff.const - rowSums(fit.rob$g.matrix[,-1]))[outliers,],
  (fit.rob$y  - fit.rob$Z%*%fit.rob$coeff.lin - fit.rob$coeff.const - rowSums(fit.rob$g.matrix[,-2]))[outliers,],
  (fit.rob$y  - fit.rob$Z%*%fit.rob$coeff.lin - fit.rob$coeff.const - rowSums(fit.rob$g.matrix[,-3]))[outliers,]
)
)
names(DF3point) <- c("x1.x","x2.x","x3.x","re.x1","re.x2","re.x3")
DF4 <- as.data.frame(list(
  rbind(X.del,X),
  c(fit.del.cl$y  - fit.del.cl$Z%*%fit.del.cl$coeff.lin - fit.del.cl$coeff.const - rowSums(fit.del.cl$g.matrix[,-1]),fit.rob$y  - fit.rob$Z%*%fit.rob$coeff.lin - fit.rob$coeff.const - rowSums(fit.rob$g.matrix[,-1])),
  c(fit.del.cl$y  - fit.del.cl$Z%*%fit.del.cl$coeff.lin - fit.del.cl$coeff.const - rowSums(fit.del.cl$g.matrix[,-2]),fit.rob$y  - fit.rob$Z%*%fit.rob$coeff.lin - fit.rob$coeff.const - rowSums(fit.rob$g.matrix[,-2])),
  c(fit.del.cl$y  - fit.del.cl$Z%*%fit.del.cl$coeff.lin - fit.del.cl$coeff.const - rowSums(fit.del.cl$g.matrix[,-3]),fit.rob$y  - fit.rob$Z%*%fit.rob$coeff.lin - fit.rob$coeff.const - rowSums(fit.rob$g.matrix[,-3])),
